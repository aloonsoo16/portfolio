...
//Cambiar los colores y aparencia de los iconos de la animacion de descarga cuando el tema es oscuro
document.getElementById('spinner-button').addEventListener('click', function() {
    // Verifica si el tema es bg-dark
    if (document.body.classList.contains('bg-dark')) {
        ...
        setTimeout(() => {
            ...
            const animacionlineEnd = function() {
                fill.style.border = '3px solid #48ff00';
                downloadIcon.style.animation = 'up 2s forwards';
                pathDownload.setAttribute('d', 'm17.582,8.461c.573.597.555,1.547-.043,2.121l-4.605,4.424c-.668.659-1.552.989-2.438.989s-1.774-.33-2.451-.991l-1.547-1.388c-.616-.554-.667-1.502-.113-2.118.554-.615,1.5-.668,2.119-.113l1.592,1.43c.237.23.555.232.746.042l4.62-4.438c.597-.574,1.545-.557,2.121.042Zm6.418,3.539c0,6.617-5.383,12-12,12S0,18.617,0,12,5.383,0,12,0s12,5.383,12,12Zm-3,0c0-4.962-4.037-9-9-9S3,7.038,3,12s4.037,9,9,9,9-4.038,9-9Z');
                pathDownload.setAttribute('fill', '#48ff00');

                setTimeout(() => {
                    downloadIcon.style.animation = 'right 2s forwards';
                    downloadIcon.addEventListener('animationend', function() {
                        fill.style.opacity = '0';
                        fill.remove();
                        pathDownload.setAttribute('d', 'M16,12v2c0,1.103-.897,2-2,2h-4c-1.103,0-2-.897-2-2v-2H0v9c0,1.654,1.346,3,3,3H21c1.654,0,3-1.346,3-3V12h-8Zm6,9c0,.552-.448,1-1,1H3c-.552,0-1-.448-1-1v-7H6c0,2.206,1.794,4,4,4h4c2.206,0,4-1.794,4-4h4v7ZM10.586,10.414l-3.293-3.293,1.414-1.414,2.293,2.293V0h2V8l2.293-2.293,1.414,1.414-3.293,3.293c-.39,.39-.902,.585-1.414,.585s-1.024-.195-1.414-.585Z');
                        pathDownload.setAttribute('fill', 'aqua');
                ...
                setTimeout(() => {
                    ...
                    spinner.style.borderTop = '3px solid aqua';
            ...
            const animacionlineEnd = function() {
                ...
                setTimeout(() => {
                    ...
                    downloadIcon.addEventListener('animationend', function() {
                        ...
                        fill.remove();
                        pathDownload.setAttribute('d', 'M16,12v2c0,1.103-.897,2-2,2h-4c-1.103,0-2-.897-2-2v-2H0v9c0,1.654,1.346,3,3,3H21c1.654,0,3-1.346,3-3V12h-8Zm6,9c0,.552-.448,1-1,1H3c-.552,0-1-.448-1-1v-7H6c0,2.206,1.794,4,4,4h4c2.206,0,4-1.794,4-4h4v7ZM10.586,10.414l-3.293-3.293,1.414-1.414,2.293,2.293V0h2V8l2.293-2.293,1.414,1.414-3.293,3.293c-.39,.39-.902,.585-1.414,.585s-1.024-.195-1.414-.585Z');
                        pathDownload.setAttribute('fill', '#FF8C00');
                        downloadIcon.style.opacity = '1';
                        downloadIcon.style.animation = 'left 2s forwards';
                    }, { once: true });
                }, 3000);
                ...
                setTimeout(() => {
                    spinnerButton.style.pointerEvents = 'auto';
                    spinner.style.animationPlayState = 'running';
                    spinner.style.borderTop = '3px solid #FF8C00';
                    dropdown.style.pointerEvents = 'auto';
                    setTimeout(()=>{
                        location.reload();
                    },2200);
